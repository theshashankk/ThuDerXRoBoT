...
TELEPIC = (
    PMPERMIT_PIC
    if PMPERMIT_PIC
    else "https://telegra.ph/file/115ae749601003099e2a0.jpg"
)
PM_WARNS = {}
PREV_REPLY_MESSAGE = {}
myid = bot.uid
...
MESAG = (
    str(CUSTOM_PMPERMIT)
    if CUSTOM_PMPERMIT
    else "`Thunder X PM security! Please wait for me to approve you. 😊"
)
...
if Var.TG_BOT_USER_NAME_BF_HER is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if event.query.user_id == bot.uid and query.startswith("`Userbot"):
            ...
            result = builder.article(
                title="Stats",
                text=f"**Thunder X Stats For [{DEFAULTUSER}](tg://user?id={myid})**\n\n__Bot is functioning normally, master!__\n\n(c) @TeleBotSupport",
                buttons=[
                    [custom.Button.inline("Stats", data="statcheck")],
                    [Button.url("Repo", "https://github.com/theshashankk/ThunderXRoBoT")],
                    [
                        Button.url(
                            "Deploy Now!",
                            "https://heroku.com/deploy?template=https://github.com/Theshashankk/thunderx",
                        )
                    ],
                ],
            )
            ...
            result = builder.article(
                ...
                buttons=[
                    ...
                    [Button.url("Op Creator", "https://t.me/Theshashank")],
                ],
            )
        else:
            result = builder.article(
                "Source Code",
                text="**Welcome to kalyug 😂😂**\n\n`Click below buttons for more`",
                buttons=[
                    [custom.Button.url("Creator👨‍🦱", "https://t.me/Theshashank")],
                    [
                        custom.Button.url(
                            "👨‍💻Source Code‍💻", "https://github.com/theshashankk/ThunderXRoBoTX
